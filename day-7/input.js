const input = `shiny plum bags contain no other bags.
...
light violet bags contain 3 clear black bags, 3 mirrored indigo bags, 5 striped coral bags, 2 dim crimson bags.`.split(
    '\n'
);
